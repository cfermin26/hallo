        ...
        <Container fluid className="background">
          <Row>
            <Col md={12} className="px-0">
              <StaticImage
                src="../images/agencias/portoviejo/hallo-portoviejo.jpg"
                alt="Hallo banner"
                layout="fullWidth"
              />
            </Col>
                      ...
                      <Container className="px-0">
                        <Row>
                          <Col xs={6} md={6} className="px-md-4">
                            <StaticImage
                              src="../images/agencias/portoviejo/planes/portoviejo-plan-basic.png"
                          ...
                          <Col xs={6} md={6} className="px-md-4">
                            <StaticImage
                              src="../images/agencias/portoviejo/planes/portoviejo-plan-house.png"
                    ...
                    <div className="agency-card p-4 p-md-5">
                      <Container className="px-0">
                        <Row>
                          <Col xs={6} md={6} className="px-md-4">
                            <StaticImage
                              src="../images/agencias/portoviejo/planes/portoviejo-plan-pro.png"
                              alt="Hallo plan basic"
                              layout="fullWidth"
                            />
                          </Col>
                          <Col xs={6} md={6} className="px-md-4">
                            <StaticImage
                              src="../images/agencias/portoviejo/planes/portoviejo-plan-gamer.png"
                              alt="Hallo plan house"
                              layout="fullWidth"
                            />
                          </Col>
                    ...
                    <div className="agency-card p-4 p-md-5">
                      <Container className="px-0">
                        <Row>
                          <Col xs={6} md={6} className="px-md-4">
                            <StaticImage
                              src="../images/agencias/portoviejo/planes/portoviejo-plan-platinum.png"
                              alt="Hallo plan basic"
                              layout="fullWidth"
                            />
                          </Col>
                          <Col xs={6} md={6} className="px-md-4">
                            <StaticImage
                              src="../images/agencias/portoviejo/planes/portoviejo-plan-infinity.png"
                              alt="Hallo plan house"
                              layout="fullWidth"
                            />
                          </Col>
