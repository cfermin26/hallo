        ...
        <Container fluid className="background">
          <Row>
            <Col md={12} className="px-0">
              <StaticImage
                src="../images/agencias/la-troncal/hallo-la-troncal.jpg"
                alt="Hallo banner"
                layout="fullWidth"
              />
            </Col>
                      ...
                      <Container className="px-0">
                        <Row>
                          <Col
                            ...
                            className="px-md-4"
                            onClick={(e) =>
                              openModal(e, "BASIC", "45", "$17.50")
                            }
                          >
                            <StaticImage
                              src="../images/agencias/la-troncal/planes/la-troncal-plan-basic.png"
                          ...
                          <Col
                            ...
                            className="px-md-4"
                            onClick={(e) =>
                              openModal(e, "HOUSE", "65", "$22.00")
                            }
                          >
                            <StaticImage
                              src="../images/agencias/la-troncal/planes/la-troncal-plan-house.png"
                      ...
                      <Container className="px-0">
                        <Row>
                          <Col
                            ...
                            md={6}
                            className="px-md-4"
                            onClick={(e) => openModal(e, "PRO", "80", "$26.50")}
                          >
                            <StaticImage
                              src="../images/agencias/la-troncal/planes/la-troncal-plan-pro.png"
                              alt="Hallo plan pro"
                              layout="fullWidth"
                            />
                          </Col>
                          <Col
                            ...
                            className="px-md-4"
                            onClick={(e) =>
                              openModal(e, "GAMER", "100", "$35.50")
                            }
                          >
                            <StaticImage
                              src="../images/agencias/la-troncal/planes/la-troncal-plan-gamer.png"
                      ...
                      <Container className="px-0">
                        <Row>
                          <Col
                            ...
                            className="px-md-4"
                            onClick={(e) =>
                              openModal(e, "PLATINUM", "160", "$53.50")
                            }
                          >
                            <StaticImage
                              src="../images/agencias/la-troncal/planes/la-troncal-plan-platinum.png"
                          ...
                          >
                            <StaticImage
                              src="../images/agencias/la-troncal/planes/la-troncal-plan-infinity.png"
