  ...
  return (
    <Layout>
      <main>
        ...
        <Container fluid className="background">
          <Row>
            <Col md={12} className="px-0">
              <StaticImage
                src="../images/agencias/las-naves/hallo-las-naves.jpg"
                alt="Hallo banner"
                layout="fullWidth"
              />
            </Col>
                    ...
                    <div className="agency-card p-4 p-md-5">
                      <Container className="px-0">
                        <Row>
                          ...
                          >
                            <StaticImage
                              src="../images/agencias/las-naves/planes/las-naves-plan-basic.png"
                          ...
                          >
                            <StaticImage
                              src="../images/agencias/las-naves/planes/las-naves-plan-house.png"
                      ...
                      <Container className="px-0">
                        <Row>
                          <Col
                            ...
                            md={6}
                            className="px-md-4"
                            onClick={(e) => openModal(e, "PRO", "65", "$33.50")}
                          >
                            <StaticImage
                              src="../images/agencias/las-naves/planes/las-naves-plan-pro.png"
                              alt="Hallo plan pro"
                              layout="fullWidth"
                            />
                          </Col>
                          ...
                          >
                            <StaticImage
                              src="../images/agencias/las-naves/planes/las-naves-plan-gamer.png"
                    ...
                    <div className="agency-card p-4 p-md-5">
                      <Container className="px-0">
                        <Row>
                          ...
                          >
                            <StaticImage
                              src="../images/agencias/las-naves/planes/las-naves-plan-platinum.png"
        ...
        <ModalPlan
          planAgencia={"Bolívar - Las Naves"}
          planEmail={"ventas.lasnaves@hallo.ec"}
          planNombre={nombre}
          planMegas={megas}
          planPrecio={precio}
          setShow={setShow}
